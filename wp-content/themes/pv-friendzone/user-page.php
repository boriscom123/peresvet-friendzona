...
if (is_user_logged_in()) {
    ...
    $form_link = '';
    if (count($lead['custom_fields_values']) > 0) {
        ...
        <div class="main-user">
            <div class="container">
                ...
                <div class="user-pages">
                    ...
                    <div class="user-code <?php if ($nav != 1 || $nav != 1) {
                        echo 'd-none';
                    } ?>">
                        ...
                        <div class="info">
                            <div>
                                ...
                                echo "Ваша индивидуальная ссылка";
                                ?>
                            </div>
                    ...
                    <div class="user-bonus <?php if ($nav != 1 || $nav != 1) {
                        echo 'd-none';
                    } ?>">
                        <?php
                    ...
                    <div class="user-bank <?php if ($nav != 1 || $nav != 1) {
                        echo 'd-none';
                    } ?>">
                        <h2>Копилка</h2>
                    ...
                    <div class="user-contacts <?php if ($nav != 3) {
                        ...
                        <div class="info-field">
                            ...
                            <?php //if(!empty($user_data->last_name)){ print 'value="'.$user_data->last_name.'"'; } else { print 'placeholder="Фамилия"'; } ?><!-- form="user-contacts">-->
                        </div>
                        <div class="info-field">
                            <p>Город<span>*</span></p>
                            ...
                            <?php //if(isset($all_meta_for_user['patronymic'])){print 'value="'.$all_meta_for_user['patronymic'][0].'"';} else {print 'placeholder="Отчество"';} ?><!-- form="user-contacts">-->
                        </div>
